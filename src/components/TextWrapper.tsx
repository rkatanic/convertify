  ...
  <div className="top-0 left-0 w-full">
    <div className="border-l border-neutral-800 ml-8 py-5 flex items-baseline justify-between font-thin text-white">
      <div className="ml-5 relative text-neutral-400 font- text-lg">
        <span className="ml-1">Converted Text</span>
        <div className="flex items-center justify-center w-6 h-6 border bg-neutral-900 border-emerald-800 rounded-full absolute -left-[2rem] top-[0.175rem]">
          <FiRepeat size="0.75rem" className="rotate-90 stroke-emerald-400" />
        </div>
      </div>
    </div>
